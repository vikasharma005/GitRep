...
# Sidebar
st.sidebar.image("https://github.com/vikasharma005/GitRep/blob/main/github-logo.png", width=100)
...
if github_username:
    ...
    with col1:
        ...
        if 'avatar_url' in profile:
            ...
            st.write("**Name:**", profile['name'] or "Not provided")
            st.write("**Bio:**", profile['bio'] or "Not provided")
            st.write("**Location:**", profile['location'] or "Not provided")
